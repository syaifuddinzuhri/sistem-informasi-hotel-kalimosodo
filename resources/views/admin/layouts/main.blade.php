...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin-templates') }}/assets/vendors/perfect-scrollbar/perfect-scrollbar.css">
...
<body>
    ...
    <script src="{{ asset('admin-templates') }}/assets/vendors/apexcharts/apexcharts.js"></script>
