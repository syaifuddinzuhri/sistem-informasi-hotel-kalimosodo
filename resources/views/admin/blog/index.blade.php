            ...
            <form id="formAddBlog" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="content" name="content" placeholder="Enter Konten"
                            rows="3"></textarea>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="formEditBlog" method="PUT">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="content" class="form-label">Konten</label>
                        <textarea class="form-control" id="content_edit" name="content" placeholder="Enter Konten"
                            rows="3"></textarea>
                    </div>
                    <div class="form-group">
...
{{-- Delete Modal --}}
<div class="modal fade text-left" id="deleteBlogModal" tabindex="-1" role="dialog"
